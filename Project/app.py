...
# Custom CSS for large file uploader
st.markdown("""
    <style>
...
# ------------------------------
# Global variables for PII types
# ------------------------------
...
with tab1:
    if st.session_state.processed and st.session_state.masked_df is not None:
        ...
        # Metrics and Analytics (moved below data preview)
        ...
        with st.container():
            ...
            with export_col2:
                # Verification report (add empty write to align)
                st.write("")
                st.write("")
                # Verification report
